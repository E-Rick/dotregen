import { useColorMode, IconButton, Tooltip, Button, Box, Icon, VisuallyHidden } from '@chakra-ui/react';
  ...
  return (
    ...
    >
      <IconButton
        ...
        <VisuallyHidden>Toggles between light and dark mode.</VisuallyHidden>
      </IconButton>
    </Tooltip>
  );
};
