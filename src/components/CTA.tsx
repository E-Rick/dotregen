import { Link as ChakraLink, Tooltip, Container, IconButton, Box } from '@chakra-ui/react'
import Image from 'next/image'
export const CTA = () => (
  <Box display='flex' flexDirection='row' position='fixed' bottom={0} left={0} width='full' py={3} zIndex={100}>
